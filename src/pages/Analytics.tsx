...
const Analytics = () => (
  <div>
    <div className="mb-8">
      ...
      <h1 className="mt-1 font-serif text-3xl font-bold text-ink-900">Analytics</h1>
      <p className="mt-2 font-sans text-sm text-ink-500">
        Detailed analytics and marketplace insights.
      </p>
    </div>
    <div className="rounded-xl border-2 border-cream-300 bg-white p-6 shadow-md">
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="font-serif text-base text-ink-600">No data to display yet</p>
        <p className="mt-1 font-sans text-sm text-ink-400">Analytics will populate once the marketplace goes live.</p>
      </div>
    </div>
  </div>
)
